...
const ProductCard = ({product}) => {
  ...
  <div className=" lg:px-6 px-2 py-2">
        ...
        <div className="flex justify-between items-start">
             <h3 data-aos="fade-right" className="  lg:text-lg text-[12px]  font-medium text-[#c73f8a]">{name}</h3>
        <button
    ...
    <p data-aos="fade-right" className="lg:mt-1.5 absolute lg:bottom-16 sm:bottom-8  lg:text-sm   text-[10px] text-gray-700"><span className="text-green-500 font-bold">{price}</span> BDT
    </p>
